        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card w-100">
                    <div class="card-body">
                        <form action="/simpan-vendor" method="POST" class="row">
                            @csrf
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nama Vendor</label>
                                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="exampleFormControlInput1" placeholder="masukkan nama vendor" value="{{ old('nama') }}">
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" rows="3" placeholder="Masukkan alamat vendor">{{ old('alamat') }}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
